...
<section class="banner-section banner-one">
   ...
   <div class="banner-carousel owl-theme owl-carousel">
       ...
       <div class="slide-item">
           <div class="image-layer" style="background-image: url({{asset('public/client/images/background/back1.jpg')}});"></div>
           ...
           <div class="auto-container">
               <div class="content-box">
                   <div class="content">
                       <div class="inner">
                           <div class="sub-title">welcome to DigiZigs agency</div>
