...
class CourseController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('digilearn.pages.course.course');
    ...
    public function create()
    {
        ...
        return view('digilearn.pages.course.course_add',compact('lessons'));
    }
    ...
    public function show($id)
    {
        ...
        return view('digilearn.pages.course.course_view',compact('lessons','course'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('digilearn.pages.course.course_edit',compact('course','lessons'));
    }
