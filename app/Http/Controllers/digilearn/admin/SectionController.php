...
class SectionController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('digilearn.pages.section.section');
    ...
    public function create()
    {
        ...
        //dd($teachers);
        return view('digilearn.pages.section.section_add',compact('courses','teachers'));
    }
    ...
    public function show($id)
    {
        ...
        return view('digilearn.pages.section.section_view',compact('section'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('digilearn.pages.section.section_edit',compact('section','courses','teachers'));
    }
