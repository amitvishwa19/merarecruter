...
class IssuedBookController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('digilearn.dashboard.pages.issuedbook.issuedbook');
    ...
    public function create()
    {
        ...
        return view('digilearn.dashboard.pages.issuedbook.issuedbook_add',compact('users','books'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('digilearn.dashboard.pages.issuedbook.issuedbook_edit',compact('issuedbook'));
    }
