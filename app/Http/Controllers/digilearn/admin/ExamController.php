...
class ExamController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('digilearn.pages.exam.exam');
    ...
    public function create()
    {
        ...
        return view('digilearn.pages.exam.exam_add',compact('questions'));
    }
    ...
    public function show($id)
    {
        ...
        return view('digilearn.pages.exam.exam_view',compact('exam'));
    ...
    public function edit($id)
    {
        ...
        return view('digilearn.pages.exam.exam_edit',compact('exam','questions'));
    }
